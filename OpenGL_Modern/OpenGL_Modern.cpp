...
//        std::cout << "Python cherche ici : " << sys.attr("path").cast<py::list>()[0].cast<std::string>() << std::endl;
//
//        sys.attr("path").attr("append")("./src");
//        sys.attr("path").attr("append")(".");
//
//        py::module_ script = py::module_::import("CameraLogic");
//
//        py::print("Import de CameraLogic reussi !");
//    }
...
int main(void)
{
    ...
    py::module_ script;
    try {
        script = py::module_::import("CameraLogic");
    }
    catch (py::error_already_set& e) {
        std::cerr << "Erreur Python : " << e.what() << std::endl;
        return -1;
